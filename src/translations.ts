...
export const translations: Record<string, UIStrings> = {
  en: {
    ...
    step1Label: "Step 1: Upload Real Civic Issue Photo (Primary Path)",
    ...
    step2Label: "Step 2: Pin Exact Location on Map (Interactive)",
    ...
    step3Label: "Step 3: Landmark / Location Description (Optional Description)",
  ...
  hi: {
    ...
    step1Label: "चरण 1: वास्तविक नागरिक समस्या का फोटो अपलोड करें (मुख्य पथ)",
    ...
    step2Label: "चरण 2: मानचित्र पर सटीक स्थान पिन करें (इंटरैक्टिव)",
    ...
    step3Label: "चरण 3: लैंडमार्क / स्थान विवरण (वैकल्पिक विवरण)",
  ...
  mr: {
    ...
    step1Label: "पायरी 1: वास्तविक नागरी समस्येचा फोटो अपलोड करा (मुख्य मार्ग)",
    ...
    step2Label: "पायरी 2: नकाशावर अचूक स्थान पिन करा (परस्परसंवादी)",
    ...
    step3Label: "पायरी 3: लँडमार्क / स्थान वर्णन (पर्यायी वर्णन)",
